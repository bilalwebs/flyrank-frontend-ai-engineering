...
export const metadata: Metadata = {
  ...
  description:
    "Practice technical interviews with an AI-powered coach. Get personalized feedback, identify weaknesses, and improve your skills.",
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" className={`${geistSans.variable} ${geistMono.variable} h-full antialiased`} suppressHydrationWarning data-scroll-behavior="smooth">
      <body className="flex min-h-full flex-col bg-white text-zinc-900 dark:bg-zinc-950 dark:text-zinc-100" suppressHydrationWarning>
        <a
          href="#main-content"
