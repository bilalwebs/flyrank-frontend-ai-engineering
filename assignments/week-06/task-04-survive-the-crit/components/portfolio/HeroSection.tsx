    ...
    <section className="flex min-h-[60vh] sm:min-h-[70vh] flex-col items-center justify-center px-2 text-center">
      ...
      >
        ...
        <motion.p
          ...
          className="mt-4 max-w-2xl text-base text-gray-300 sm:mt-6 sm:text-lg"
        >
          {PROFILE.tagline}
        </motion.p>
        ...
        <motion.div
          ...
          className="mt-6 flex justify-center gap-4 sm:mt-8"
        >
          <a
            href={PROFILE.github}
            target="_blank"
            ...
            className="min-h-[44px] min-w-[44px] inline-flex items-center gap-2 rounded-lg border border-white/10 px-4 py-2 text-sm text-gray-400 transition-all hover:border-white/20 hover:text-white focus:outline-none focus:ring-2 focus:ring-purple-500/50"
          >
