...
Hero, FeaturedSkills, FeaturedProjects, CTASection, AboutHero, ExperienceTimeline, StatsSection, SkillsHero, SkillsCategory, SkillsGrid, ProjectsHero, FeaturedProject, ProjectsGrid, ContactHero, ContactForm, ContactInfoSection.
...
- Turbopack dev + production bundler
